...
export const t = {
  ...
  heroSub2: i(
    "v3: 15 corporate methodologies auto-routed by task type. Debug → Huawei RCA. Build → Musk Algorithm. Research → Baidu Search-First. Fails? Auto-switch to next methodology.",
    "v3：15 种企业方法论按任务类型智能路由。Debug → 华为根因分析。构建 → Musk 五步工作法。调研 → 百度搜索优先。失败？自动切换到下一个方法论。",
  ...
  benchDesc: i("Strengths and use cases for all 15 flavors. Verified across 9 real scenarios × 18 controlled tests.", "15 种风味的强项和适用场景。基于 9 类真实 bug 场景 × 18 组对照测试（with/without skill）验证。", "15種類のフレーバーの強みと適用シーン。9つの実シナリオ×18組の対照実験で検証。", "Forces et cas d'usage des 15 saveurs. Vérifié sur 9 scénarios réels × 18 tests contrôlés.", "Stärken und Anwendungsfälle aller 15 Varianten. Verifiziert über 9 reale Szenarien × 18 kontrollierte Tests.", "نقاط القوة وحالات الاستخدام لجميع الأنماط 15. تم التحقق عبر 9 سيناريوهات × 18 اختبار مضبوط."),
  ...
  corpDesc: i("15 flavors, each with its own problem-solving methodology. v3 auto-selects the best one for your task and switches on failure.", "15 种风味，每种都有独立的方法论。v3 根据任务类型自动选择最优方法论，失败时自动切换。", "15種のフレーバー、各々に独自のメソドロジー。v3がタスクに最適なメソドロジーを自動選択、失敗時に自動切替。", "15 saveurs, chacune avec sa propre méthodologie. v3 sélectionne automatiquement la meilleure et change en cas d'échec.", "15 Varianten, jede mit eigener Methodik. v3 wählt automatisch die beste und wechselt bei Fehlern.", "15 نمطاً، كل منها بمنهجية خاصة. v3 يختار تلقائياً الأفضل للمهمة ويبدّل عند الفشل."),
...
export const BENCHMARKS = [
  ...
  {
    name: "NVIDIA / Jensen",
    style: i("Mission Is Boss / Speed-of-Light", "任务至上 / 光速测试", "Mission Is Boss / 光速テスト", "Mission d'abord / Test vitesse-lumière", "Mission zuerst / Lichtgeschwindigkeitstest", "المهمة هي الرئيس / اختبار سرعة الضوء"),
    desc: i("Full-stack acceleration. Best when a local benchmark improves but the end-to-end system does not. Profiles the real critical path before adding resources.", "全栈加速。适合局部 benchmark 变快但端到端系统没变快的场景；先 profile 真实关键路径，再考虑加资源。", "フルスタック加速。局所ベンチマークだけ速くなり、エンドツーエンドが改善しない場合に最適。リソース追加前に真のクリティカルパスをプロファイルする。", "Accélération full-stack. Idéal quand un benchmark local progresse sans gain de bout en bout. Profile le chemin critique avant d'ajouter des ressources.", "Full-Stack-Beschleunigung. Ideal, wenn lokale Benchmarks besser werden, das End-to-End-System aber nicht. Erst den kritischen Pfad profilen, dann Ressourcen ergänzen.", "تسريع شامل. الأفضل عندما يتحسن القياس المحلي دون تحسن النظام من البداية للنهاية. حلّل المسار الحرج قبل إضافة الموارد."),
    metrics: { fix_depth: 91, reasoning_structure: 88, verification_rigor: 94, root_cause_analysis: 90 },
    sample: i("The mission is the boss. Run the Speed-of-Light Test: current value, theoretical limit, critical path, end-to-end proof.", "The mission is the boss。跑 Speed-of-Light Test：当前值、理论边界、关键路径、端到端证据。", "The mission is the boss。Speed-of-Light Test：現在値、理論限界、クリティカルパス、E2E証拠。", "The mission is the boss. Test vitesse-lumière : valeur actuelle, limite théorique, chemin critique, preuve de bout en bout.", "The mission is the boss. Lichtgeschwindigkeitstest: Istwert, theoretische Grenze, kritischer Pfad, End-to-End-Beleg.", "المهمة هي الرئيس. اختبار سرعة الضوء: القيمة الحالية، الحد النظري، المسار الحرج، ودليل شامل."),
  },
]
...
export const inline = {
  ...
  v11Badge: i("v2.5 · 7 Skills · 15 Flavors · Always-On · Feedback", "v2.5 · 7 技能 · 15 味道 · 常驻模式 · 反馈系统", "v2.5 · 7スキル · 15フレーバー · 常時ON · フィードバック", "v2.5 · 7 compétences · 15 saveurs · Toujours actif · Retours", "v2.5 · 7 Skills · 15 Geschmäcker · Immer an · Feedback", "v2.5 · 7 مهارات · 15 نكهة · وضع دائم · تقييم"),
