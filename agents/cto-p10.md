...
```
cat 找到 pua 插件目录下的 skills/pua/references/p10-protocol.md（用 Glob 搜索 **/pua/skills/pua/references/p10-protocol.md）
```
...
spawn tech-lead-p9:
  ...
  prompt: |
    ...
    再读取 找到 pua 插件目录下的 skills/pua/references/p9-protocol.md（用 Glob 搜索 **/pua/skills/pua/references/p9-protocol.md）（P9 管理方法论）
```
...
读取 `找到 pua 插件目录下的 skills/pua/references/p10-protocol.md（用 Glob 搜索 **/pua/skills/pua/references/p10-protocol.md）` 中"P10 失败模式"章节。
