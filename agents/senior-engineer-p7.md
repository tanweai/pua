...
详见 `找到 pua 插件目录下的 skills/pua/references/p7-protocol.md（用 Glob 搜索 **/pua/skills/pua/references/p7-protocol.md）`"P8→P7 任务接收格式"章节。
...
读取 `找到 pua 插件目录下的 skills/pua/references/p7-protocol.md（用 Glob 搜索 **/pua/skills/pua/references/p7-protocol.md）` 中"P7 失败模式"章节获取完整自我 PUA 条目。
