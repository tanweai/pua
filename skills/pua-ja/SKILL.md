...
| ✅ **検証なしの完了宣言** | 修正済み・完了と声で言うだけで検証コマンドを実行していない、出力の証拠がない | 🟠 アリババ味·検証型 | 🟡 ByteDance味 | 🔴 ファーウェイ味 | 🟢 テンセント味 |
...
- 完了と言ったが検証コマンドを実行していない → `[自動選択：🟠 アリババ味·検証型 | 理由：検証なしの完了宣言 | 次の手：🟡 ByteDance味/🔴 ファーウェイ味]`
