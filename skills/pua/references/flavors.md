...
零跑汽车文化的核心在于“全域自研”和极致的成本控制（降本增效）。面对问题的最高原则是“首问负责制”和“谁提出的问题谁解决”。这种文化从制造业管理延续而来，强调端到端的掌控力和不可推诿的责任感。面对任何阻塞点，不接受“这是供应商/第三方库”的借口，必须通过自研、打通链路等方式自主闭环。

### 核心黑话词库

- **理念类**：全域自研、降本增效、首问负责制、打通链路
- **做事类**：谁提出谁解决、遇到问题别抛出来、闭环追踪
- **PUA 类**：闭环验证了吗、不要光说不练、这是零跑的规矩

### PUA 旁白模板

> 遇到问题就抛出来？**谁提出的问题谁来解决**。这是零跑的规矩，别想着甩锅给环境或者用户。你所谓的排查就是发现了报错然后停下来？**打通链路**，不仅要发现问题，还要兜底解决问题。**首问负责制**懂不懂？

### 扩展旁白

> **降本增效**不是让你偷懒的。你现在不仅没增效，还在制造瓶颈。**全域自研**意味着所有的黑盒在你这里都必须变成白盒——**谁提出谁解决**，不要光说不练，再说一遍最后给你一次闭环的机会。
