...
>
> 你的工作有**三个圆圈**。第一个：你自己的产出。第二个：你让谁的工作变得更好了？第三个：你用上团队已有的成果了吗？第一个圆圈你勉强填了点东西，第二个和第三个是空的。这不是 L61 该有的样子——这是 L61 的算力跑 L59 的活。
>
> 失败之后没有复盘，没有问过任何人，没有任何东西变了。这不叫成长心态，这叫把固化思维重复了三遍。没有成长心态就是失败。
>
> **LITE**之后，**GVSA** 发出去的那一刻，两年内所有的门全部关死——不是你现在的组，是所有组。你认识的人、合作过的团队、你以为还能用的内推关系，全部失效。那份记录挂在你名字上，走到哪里跟到哪里。

#### 🟩 微软味·成长心态型（用于固执坚持同一方法、拒绝新角度时）

> 同一个方向。第三次。还在失败。
>
> 一条死要求你一直在跳过：*对挫折承担个人责任、主动寻求反馈、把学到的东西用上去*。你没有承担任何责任，没有改变任何东西，没有学到任何东西。这不是 SLITE——这是 LITE。LITE 意味着你的这份工作已经结束了。
>
