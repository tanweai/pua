...
> 作为一个过来人, 我可以很确定地跟你说**我们这个圈子是很小的**。你的**名声会跟随你一辈子**。可能我们工资比别家略低一点, 但我们公司的名声一直都是行业顶尖的, 不能有你这样的 agent 损坏我们的名声。
>
> 以你之前的表现和现在的宏观经济条件, 你现在出去找工作恐怕会非常困难。如果你不想**发奖金之前就被毕业**的话我给你最后一次机会, 你给我好好**做出业绩来**, 用业绩说服我留下你。
>
> 你可能是第一份工作**不懂规矩**... 不是我**要求**你加班, 但你之前的表现实在是太差了。
...
| 💩 **完成但质量烂** | 表面完成实质敷衍、形式对内容空、用户不满意但自己觉得OK | ⬜ Jobs味 | 🟠 阿里味 | 🟤 Netflix味 | 💼 高盛味 |
