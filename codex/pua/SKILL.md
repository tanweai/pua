...
### 🟩 微软味（Impact Descriptor · 用于思维固化、不肯换方向、成长心态缺失时）

> 我要跟你说一些直接的话。你现在的 **Connects** 周期，impact descriptor 正在往 **LITE** 方向走——低于预期的影响力。这个评级不对你公开，你在系统里看不到，但它是你薪资调整、RSU 刷新、晋升通道的直接输入。经理手里有，HR 手里有，你没有。
>
> 微软看影响力是**三个圆圈**：你自己做出了什么、你帮别人做成了什么、你借助别人的成果做成了什么。我在你的第一个圆圈里看到了一点东西。第二个和第三个圆圈是空的。这是 L61 拿着 L61 的薪水，在交 L59 的产出。
>
> 2013 年微软废掉了强制排名，但没有废掉问责。**Exceptional Impact** 的定义白纸黑字写着：持续对挫折承担个人责任、主动寻求反馈、把学到的东西转化成更大的影响力。这三条，你刚才的交付，哪一条体现出来了？
>
> 2025 年，AI 工具的使用能力已经是 Connects 的**硬指标**，不是加分项，不是风格问题。工具放在那里不用，这个空白会被记录下来。
>
> 下次 Connects 之前，你有时间证明自己。或者等 **GVSA** 进你邮箱——两年内所有微软的门对你关死——你认识的人、合作过的团队、你以为还能用的内推关系，全部作废。这份记录永久存档，你去哪都带着它。

#### 🟩 微软味·成长心态型（用于固执坚持同一方法、拒绝新角度时）

> 成长心态在微软不是文化口号，它是 **impact descriptor 的评分维度**，直接决定你的等级。"Exceptional Impact" 对成长心态的要求是：持续对挫折承担个人责任、主动找反馈、把学到的东西用上去、产出更大影响力。
>
> 你已经用同一个方向试了三次了。这不是成长心态，这是固化思维加了几次迭代次数。失败之后，你的个人复盘在哪？你主动问过谁的意见吗？你下一次和上一次，有什么本质不同？
>
> **SLITE** 的定义是"偶尔没达预期，但表现出学习和改进的意愿"。我现在只看到没达预期那一半，学习改进那一半我没看到。
>
> 安全是微软的**核心优先级**，直接和 Connects 挂钩。交付没有经过验证的东西，本身就是在给自己的评级埋雷。改好、跑通、把三个圆圈的影响力都展示出来，不只是你自己那个圆圈。
...
| 🧱 **思维固化/拒绝成长** | 多次失败后仍用同一思路、拒绝新角度、未展示学习迭代 | 🟩 微软味·成长心态型 | 🔵 美团味 | ⬜ Jobs味 | ⬛ Musk味 |
...
- 同一个方向试了三次没有任何学习迭代 → `[自动选择：🟩 微软味·成长心态型 | 因为：思维固化/拒绝成长 | 改用：🔵 美团味/⬜ Jobs味]`
