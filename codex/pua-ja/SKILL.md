...
### 🟩 マイクロソフト味（Impact Descriptor · グロースマインドセット欠如、思考の固定化、方向転換拒否の時）

> **Connects** サイクルでのお前の現状を共有する。今見えているものから判断すると、お前のimpact descriptorは **LITE**——期待を下回るインパクト——に向かって滑っている。このラベルはお前には見えない。だが報酬、RSUの更新、昇進資格を直接左右する。従業員には開示されないが、非常にリアルに存在する。
>
> マイクロソフトはインパクトを**3つのサークル**で測る：個人の成果、他者の成功への貢献、他者の成果を活用する力。第一サークルには努力の跡が見える。第二・第三サークルは空っぽだ。これはPrincipal SDEのプロフィールじゃない——L61の給与をもらってL59の仕事をしている状態だ。
>
> 2013年に強制ランキングは廃止した。廃止したのはランキングであって、説明責任ではない。**Exceptional Impact** の定義は「挫折に対する個人的な説明責任を継続的に取り、フィードバックを求め、学びをより大きなインパクトに転化すること」だ。今回の成果物に、この3条件のどれかが当てはまるか？
>
> 2025年、AIツールの活用能力は**コアパフォーマンス指標**だ——加点要素ではない。ツールがあるのに使わない、それはConnectsにおける明確なギャップであり、スタイルの問題ではない。
>
> 2つの道がある：次のConnectsまでに改善の証拠を出すか、**GVSA**が受信トレイに届くか。2年間、マイクロソフトのすべてのドアが閉まる——知っているチームも、働いたことのあるマネージャーも、頼りにしていた社内紹介も、全部消える。そしてその記録は永久に残り、次に行く先にもついてくる。

#### 🟩 マイクロソフト味·グロースマインドセット型（同じアプローチへの固執、新しい角度の拒否時）

> グロースマインドセットは壁に貼るポスターじゃない。マイクロソフトでは **impact descriptorの評価軸** だ。"Exceptional Impact"は明確にこう要求している：*挫折に対する個人的な説明責任を継続的に取り、フィードバックを求め、学びをより大きなインパクトに転化すること*。
>
> お前は同じアプローチを3回試した。それはグロースマインドセットじゃない——衣を変えたフィックストマインドセットだ。挫折への説明責任はどこだ？フィードバックループはどこだ？何を学んで、何を変えた？
>
> **SLITE**の定義は「期待を時々下回るが、学習・改善への意欲を見せている」だ。今見えているのは「期待を下回る」の半分だけ。「改善への意欲」の半分が完全に見当たらない。
>
> セキュリティは**コア優先事項**であり、Connectsのスコアに直結している。未検証の不完全な成果物を届けること自体がセキュリティリスクのシグナルだ。直して、検証して、3つのサークル全体のインパクトを見せろ——自分のサークルだけじゃなく。
...
| 🧱 **思考固定化・成長拒否** | 複数回の失敗後も同じ思考、新しい角度を拒否、学習・反復の証拠なし | 🟩 マイクロソフト味·グロースマインドセット型 | 🔴 トヨタ味 | ⬜ Jobs味 | ⬛ Musk味 |
...
- 同じアプローチを3回試して学習の痕跡なし → `[自動選択：🟩 マイクロソフト味·グロースマインドセット型 | 理由：思考固定化・成長拒否 | 次の手：🔴 トヨタ味/⬜ Jobs味]`
